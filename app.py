...
st.markdown("""
    ...
    .missing-card { color: #e74c3c; background-color: #fff5f5; padding: 6px; border-radius: 5px; margin-bottom: 4px; border-left: 4px solid #e74c3c; font-size: 0.85rem; }
    </style>
            ...
            for line in lines:
                ...
                for idx, row in enumerate(st.session_state.courses):
                    ...
                    if subj in l:
                        ...
                        # 過濾出及格成績 (林浩宇特徵：成績大於 60 的數字通常在後面)
                        pass_scores = [int(n) for n in nums if int(n) >= 60 and int(n) <= 100]
                        ...
                        if "二年級" in paste_txt:
                            if row[5]>0 and len(pass_scores) >= 1: st.session_state[f"k_{idx}_2"] = True
